...
func TestCount(t *testing.T) {
	...
	timeData1, _ := goleTime.ParseTimeYmdHmsS("2024-07-16 11:19:23.195")
	timeData2, _ := goleTime.ParseTimeYmdHmsS("2024-07-16 11:12:23.396")
	...
	tdorm.Insert("td_china", insertMap1)
	...
	tdorm.Insert("td_china", insertMap2)
	...
	count, _ := tdorm.Count("td_china", condition.New().Eq("age", 18))
	// 新增：使用entity
